...
insts = []
CPI = []
writebacks = np.zeros(6)


for i in range(6):
    rep = 2**(7+i)
    size.append(rep)
    fileo = "X86/458.sjeng/stats/l1d_size/stats"+str(rep)+".txt"
